        ...
        <table class="table table-striped table-bordered zero-configuration mt-5">
            <thead>
                <tr class="bgcolnew">
                    ...
                    <th class="text-center" scope="col">Dimentions</th>
                    <th class="text-center" scope="col">Weight</th>
                    <th class="text-center" scope="col">Color</th>
                    <th class="text-center" scope="col">clarity</th>
            ...
            <tbody>
                ...
                @foreach ($Data as $key => $data)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $data['data']['dimensions'] }}</td>
                        <td class="text-center">{{ $data['data']['weight'] }}</td>
                        <td class="text-center">{{ $data['data']['color'] }}</td>
                        <td class="text-center">{{ $data['data']['clarity'] }}</td>
                        <td class="text-center">{{ $data['data']['treatment'] }}</td>
