        ...
        <table class="table table-striped table-bordered zero-configuration mt-5">
            ...
            <tbody>
                @foreach ($Data as $key => $data)
                    <tr>
                        <td class="text-center">{{ $data['unprocessed_grading_id'] }}</td>
                        <td class="text-center">{{ $data['unprocessed_grading_data']['specimen/bag'] }}</td>
                        <td class="text-center">{{ $data['unprocessed_grading_data']['grade'] }}</td>
                        <td class="text-center">{{ $data['unprocessed_grading_data']['weight'] }}</td>
                        <td class="text-center">{{ $data['unprocessed_grading_data']['size'] }}</td>
